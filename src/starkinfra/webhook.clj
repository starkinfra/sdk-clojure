...
(defn create
  ...
  ([webhook-params, user]
    (def java-webhook-params (clojure-to-java webhook-params))
    (def created-java-webhook (Webhook/create java-webhook-params (#'starkinfra.user/get-java-user user)))
    (java-to-clojure created-java-webhook)))
...
(defn query
  ...
  ([params, user] 
    (def java-params (clojure-query-to-java params))
    (map java-to-clojure (Webhook/query java-params (#'starkinfra.user/get-java-user user)))))
...
(defn page
  ...
  ([params, user] 
    (def java-params (clojure-page-to-java params))
    (def webhook-page (Webhook/page java-params (#'starkinfra.user/get-java-user user)))
    {:webhooks (map java-to-clojure (.webhooks webhook-page)), :cursor (.cursor webhook-page)}))
