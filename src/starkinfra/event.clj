  ...
  ([java-object]
    {
      ...
      :log (case (.subscription java-object)
            "transfer" (#'starkinfra.transfer.log/java-to-clojure (.log java-object))
            "invoice" (#'starkinfra.invoice.log/java-to-clojure (.log java-object))
            "deposit" (#'starkinfra.deposit.log/java-to-clojure (.log java-object))
            "boleto" (#'starkinfra.boleto.log/java-to-clojure (.log java-object))
            "boleto-holmes" (#'starkinfra.boleto-holmes.log/java-to-clojure (.log java-object))
            "brcode-payment" (#'starkinfra.brcode-payment.log/java-to-clojure (.log java-object))
            "boleto-payment" (#'starkinfra.boleto-payment.log/java-to-clojure (.log java-object))
            "darf-payment" (#'starkinfra.darf-payment.log/java-to-clojure (.log java-object))
            "utility-payment" (#'starkinfra.utility-payment.log/java-to-clojure (.log java-object))
            "tax-payment" (#'starkinfra.tax-payment.log/java-to-clojure (.log java-object))
            (.log java-object))
    }))
...
(defn query
  ...
  ## Options:
    ...
    - `:user` [Project or Organization, default nil]: Project or Organization map returned from starkinfra.user/project or starkinfra.user/organization. Only necessary if starkinfra.settings/user has not been set.
  ...
  ([params, user] 
    (def java-params (clojure-query-to-java params))
    (map java-to-clojure (Event/query java-params (#'starkinfra.user/get-java-user user)))))
...
(defn page
  ...
  ([params, user] 
    (def java-params (clojure-page-to-java params))
    (def event-page (Event/page java-params (#'starkinfra.user/get-java-user user)))
    {:events (map java-to-clojure (.events event-page)), :cursor (.cursor event-page)}))
...
(defn parse
  ...
  ## Parameters (optional):
    ...
    - `user` [Project]: Project map returned from starkinfra.project(). Only necessary if default project has not been set in configs.
...
(ns starkinfra.event.attempt
  ...
  (:import [com.starkinfra Event$Attempt])
...
(defn query
  ...
  ([params, user] 
    (def java-params (clojure-query-to-java params))
    (map java-to-clojure (Event$Attempt/query java-params (#'starkinfra.user/get-java-user user)))))
...
(defn page
  ...
  ([params, user] 
    (def java-params (clojure-page-to-java params))
    (def attempt-page (Event$Attempt/page java-params (#'starkinfra.user/get-java-user user)))
    {:attempts (map java-to-clojure (.attempts attempt-page)), :cursor (.cursor attempt-page)}))
